...
<body oncontextmenu="return false;" onload="load()" onresize="resize()">
  <input type="color" class="hidden" id="colorInput" value="#000000" onchange="setColor(this.value)"/>
  <center id="info"></center>
  <div onclick="toggleTools()" id="nav"><img draggable="false" src="res/tools.svg"></div>
  <div id="sidebar">
    <div id="head">
      <img onclick="save()" id="save" src="res/save.svg" draggable="false"/>
      <h1>Sketch</h1>
      </div>
    <div id="toolWrap">
      <div ondblclick="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" oncontextmenu="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" onclick="setMode(this)" data-mode="pencil" style="background-image: url(res/pencil.svg)" class="tool selected" id="tool">Pencil</div>
      <div ondblclick="clearCanvas(ctx)" oncontextmenu="clearCanvas(ctx)" onclick="setMode(this)" data-mode="eraser" style="background-image: url(res/eraser.svg)" class="tool">Eraser</div>
      <div ondblclick="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" oncontextmenu="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" onclick="setMode(this)" data-mode="line" style="background-image: url(res/line.svg)" class="tool">Line</div>
      <div ondblclick="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" oncontextmenu="setMode(this);moreSettings(this,document.getElementById('set_'+mode).innerHTML);" onclick="setMode(this)" data-mode="polygon" style="background-image: url(res/polygon.svg)" class="tool">Polygon</div>
